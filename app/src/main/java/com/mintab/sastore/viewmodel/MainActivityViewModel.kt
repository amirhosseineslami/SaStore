...
class MainActivityViewModel : ViewModel() {
    ...
    public fun uploadPicture(file: File):MutableLiveData<UploadPicModel>{
        return Repository.getInstance().uploadPicture(file,compositeDisposable)
    }
    public fun uploadPicture1(file: File):MutableLiveData<UploadPicModel>{
        return Repository.getInstance().uploadPicture1(file,compositeDisposable)
    }
    public fun uploadPictureByFileStack(file: RequestBody,fileType:String): MutableLiveData<UploadPicFileStackModel> {
        return Repository.getInstance().uploadPictureByFileStack(file,fileType,compositeDisposable)
    }
