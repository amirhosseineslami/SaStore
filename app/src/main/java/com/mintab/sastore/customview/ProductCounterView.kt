package com.mintab.sastore.customview
...
class ProductCounterView(private val viewContext: Context, private val attributeSet: AttributeSet) :
    ...
    private fun initializeViews() {
        ...
        inflate(viewContext, com.mintab.sastore.R.layout.counter_good_quantitiy_layout, this)
        addBtn = findViewById(com.mintab.sastore.R.id.counter_purchases_quantity_button_add)
        removeBtn = findViewById(com.mintab.sastore.R.id.counter_purchases_quantity_button_remove)
        textView = findViewById(com.mintab.sastore.R.id.counter_purchases_quantity_textView)
