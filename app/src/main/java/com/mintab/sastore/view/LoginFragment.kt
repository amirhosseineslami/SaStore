...
import com.mintab.sastore.databinding.FragmentLogInBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentLogInBinding = DataBindingUtil.inflate(
            inflater,
            com.mintab.sastore.R.layout.fragment_log_in, container, false
        )
    ...
    private fun loginProcessingObserver(): Observer<in Boolean> {
        return Observer<Boolean> {
            if (!it) {
                ...
                loginBtn.text = context?.getString(com.mintab.sastore.R.string.login_button_text)
            } else {
                // login process started
                val gifFromResource =
                    GifDrawable(resources, com.mintab.sastore.R.drawable.spinner_1s_200px_2)
            ...
            when (code) {
                ...
                210 -> {
                    ...
                    Alerter.create(activity = activity!!)
                        .setText(com.mintab.sastore.R.string.alert_no_account_exists)
                        ...
                        .addButton(
                            context.getString(com.mintab.sastore.R.string.alert_no_any_account_exists_button_text),
                ...
                211 -> {
                    // password is wrong
                    Toasty.error(context, com.mintab.sastore.R.string.toast_wrong_password)
                        .show()
                }
                212 -> {
                    // login successful
                    ...
                    Toasty.success(context, com.mintab.sastore.R.string.toast_login_succeed)
                        .show()
